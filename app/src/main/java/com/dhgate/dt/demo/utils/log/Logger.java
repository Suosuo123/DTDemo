package com.dhgate.dt.demo.utils.log;
    ...
    public void alert(final Context context, Object object) {
        ...
        if (null == dialog) {
            dialog = new AlertDialog.Builder(context)
                    ...
                    .setPositiveButton(context.getResources().getString(R.string.cancel), listener).create();
        ...
        public void onClick(DialogInterface dialogInterface, int which) {
            ...
            switch (which) {
                case DialogInterface.BUTTON_NEGATIVE:
                    ...
                    Toast.makeText(context, context.getResources().getString(R.string.success_copy), Toast.LENGTH_SHORT)
                            .show();
                    break;
