...
import com.dhgate.dt.demo.constants.ContantsData;
...
public class SharedPreferenceUtils {
	...
	public static void putString(String key, String value) {
		getSharedPreferences(ContantsData.SP_FILE_NAME).edit().putString(key, value).commit();
	}
	...
	public static String getString(String key) {
		return getSharedPreferences(ContantsData.SP_FILE_NAME).getString(key, "");
	}
