package com.dhgate.dt.demo.utils;
...
public class CommonUtils {
	...
	public static SpannableString setTwoColorText(String s1, String s2) {
		...
		SpannableString ss = new SpannableString(s1 + s2);
		ss.setSpan(new ForegroundColorSpan(MainApplication.getApplication().getResources().getColor(R.color.text_gray)),
				0, s1.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		ss.setSpan(new ForegroundColorSpan(MainApplication.getApplication().getResources().getColor(R.color.black)),
				s1.length(), ss.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		return ss;
	}
